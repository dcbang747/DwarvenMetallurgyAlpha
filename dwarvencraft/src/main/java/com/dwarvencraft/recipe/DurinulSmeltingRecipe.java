...
public class DurinulSmeltingRecipe extends AbstractCookingRecipe {
    ...
    public DurinulSmeltingRecipe(String group, CookingRecipeCategory category, Ingredient ingredient, ItemStack result, float experience, int cookingTime) {
        super(group, category, ingredient, result, experience, cookingTime);
    }

    @Override
    public Item getCookerItem() {
        return ModBlocks.DURINUL_FURNACE.asItem();
    }
    ...
    public RecipeType<? extends AbstractCookingRecipe> getType() {
        return ModRecipes.DURINUL_SMELTING;
    }

    @Override
    public RecipeSerializer<? extends AbstractCookingRecipe> getSerializer() {
        return ModRecipes.DURINUL_SMELTING_SERIALIZER;
    }
}
